...
class CompanyResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Select::make('status')->label('Situação')->options(['trial' => 'Teste', 'active' => 'Ativa', 'suspended' => 'Suspensa', 'cancelled' => 'Cancelada'])->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Action::make('trocarPlano')->label('Trocar plano')->form([Select::make('plan_id')->label('Plano')->options(fn () => Plan::query()->pluck('name', 'id'))->required()])->action(function (Company $record, array $data): void {
            ...
            EditAction::make()->url(fn (Company $record) => self::getUrl('edit', ['record' => $record])),
        ]);
    }
