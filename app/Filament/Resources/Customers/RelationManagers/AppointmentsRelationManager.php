...
class AppointmentsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('pet.name')->label('Pet'),
            ...
            ->headerActions([
                Action::make('novoAgendamento')->label('Novo agendamento')->icon('heroicon-o-calendar-days')->url(fn (): string => AppointmentResource::getUrl('create', ['customer_id' => $this->getOwnerRecord()->getKey()])),
            ])
            ->recordActions([
